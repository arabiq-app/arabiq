...
const headerHtml = `<div style="background: linear-gradient(135deg, #1A3470, #0D2055); padding: 32px 40px; border-radius: 12px 12px 0 0;"><div style="color: #ffffff; font-size: 26px; font-weight: 800;">Arabiq</div></div>`;
...
const goldBtn = (url, text) => `<a href="${url}" style="display: inline-block; background: linear-gradient(135deg, #C9961A, #F0C842); color: #1A3470; text-decoration: none; padding: 14px 28px; border-radius: 10px; font-weight: 800; font-size: 15px; margin: 8px 0;">${text}</a>`;

const navyBtn = (url, text) => `<a href="${url}" style="display: inline-block; background: linear-gradient(135deg, #1A3470, #2A4A9A); color: #ffffff; text-decoration: none; padding: 14px 28px; border-radius: 10px; font-weight: 700; font-size: 15px; margin: 8px 0;">${text}</a>`;
