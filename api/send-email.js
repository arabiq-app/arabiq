...
const headerHtml = `
  <div style="background: linear-gradient(135deg, #1A3470, #0D2055); padding: 36px 40px 32px; border-radius: 12px 12px 0 0; text-align: center; position: relative;">
    <div style="display: inline-block; position: relative;">
      <div style="position: absolute; top: -6px; left: 2px; width: 0; height: 0; border-style: solid; border-width: 0 8px 10px 0; border-color: transparent #C9961A transparent transparent;"></div>
      <span style="color: #ffffff; font-size: 32px; font-weight: 800; letter-spacing: -1px; font-family: Georgia, serif;">Arabiq</span>
    </div>
    <div style="margin-top: 6px; color: rgba(255,255,255,0.5); font-size: 11px; letter-spacing: 3px; text-transform: uppercase;">Arabic Learning Platform</div>
