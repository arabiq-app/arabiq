...
const STEPS = [
  { num:"01", title:"Browse Teachers", desc:"Explore verified native Arabic teachers filtered by dialect, level, and availability."},
  { num:"02", title:"Book a Trial",    desc:"Schedule a discounted 30-minute trial session at a time that suits you."},
  { num:"03", title:"Learn 1-on-1",   desc:"Join your private video class and get personalised feedback every session."},
  { num:"04", title:"Track Progress", desc:"View your booking history and progress in your personal dashboard after every class."},
];
...
<span style={{ color:C.goldLt }}>with vetted native teachers.</span>
              ...
              <p style={{ color:"rgba(255,255,255,0.7)", fontSize:15, lineHeight:1.75,
                ...
                The only tutoring marketplace built exclusively for Arabic. Learn 1-on-1 with expert native teachers, rigorously vetted for exceptional teaching quality.
              </p>
        ...
        <div style={{ paddingTop:100, minHeight:"100vh", background:C.cream, animation:"fadeIn 0.3s ease" }}>
          <div style={{ maxWidth:780, margin:"0 auto", padding:isMobile?"16px 16px 40px":"56px 40px 80px" }}>
            ...
            {[
              ...
              { title:"4. Cancellation and refunds", content:"You may cancel a booking more than 24 hours before the scheduled session time for a full refund. Cancellations made within 24 hours of the session are non-refundable, to protect the teacher's time. Trial sessions (£3) are non-refundable regardless of when the cancellation is made. Refunds are processed within 5-10 business days depending on your bank or card provider. If a teacher cancels a session, you will receive a full refund automatically."},
