import { getTeachers, getAllTeachersAdmin, createTeacher, updateTeacher, updateTeacherStatus, deleteTeacher, signUp, signIn, signOut, getCurrentUser, onAuthChange, getAllUsers, incrementTeacherStats, createBooking, getUserBookings, resetPassword, updateBookingStatus, restoreTeacherSlot, updateTeacherStripeAccount } from "./lib/supabase.js";
